<?php $folder = basename(dirname($_SERVER['PHP_SELF'] ?? '')); $prefix = in_array($folder, ['admin','auth','customer'], true) ? '../' : ''; ?>
<footer class="footer_section mt-5">
  <div class="container footer-grid">
    <p>&copy; <?= date('Y') ?> Famms Store. Fashion modern dengan pengalaman belanja yang rapi dan nyaman.</p>
